...
public class Categoria extends javax.swing.JFrame {
    ...
    private void tabla_categoriaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_categoriaMouseClicked
        ...
        txtidcategoria.setText(tabla_categoria.getValueAt(fila, 0).toString());
        txtnombrecategoria.setText(tabla_categoria.getValueAt(fila, 1).toString());
        txtdescripcioncategoria.setText(tabla_categoria.getValueAt(fila, 2).toString());
